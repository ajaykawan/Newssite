...
<div class="wrapper">
    <div class="sidebar">
     ...
     <!-- rgba(147,104,233,0.78); -->
    	<div class="sidebar-wrapper" style="background-image: url('assets/img/sidebar-1.jpg');
    ...
    ?>
        ...
        <div class="content">
            <div class="container-fluid">
                        ...
                        <div class="card">
                            <div class="header">
                                <h4 class="title">NEWS TABLE</h4>
                                 <a href="newsadd.php" class="btn btn-info">Add New</a>
                            </div>
                ...
                $dbcon->connect();
                $result = $dbcon::$con->query("SELECT * FROM news ORDER BY `id` DESC ");
                $i = 1;
                while($row = $result->fetch(PDO::FETCH_ASSOC)){
                    ...
                    <tr>
                        ...
                        <td><a href="newsedit.php?id=<?php echo $row['id'];?>"><i class="fa fa-edit"></i></a> || <a onclick="return confirm('Are you sure you want to delete?')" href="function.php?id=<?php echo $row['id'];?>&image=<?php echo $row['media']; ?>&page=news" ><i class="fa fa-trash"></i></a></td>
                    </tr>
                    <?php
                    $i++;
                }?>
