...
$dbcon->connect();
$result = $dbcon::$con->query("SELECT * FROM section_table WHERE id ={$id}");
                    ...
                    <div class="content">
                        ...
                        <input type="hidden" name="id" value="<?php echo $data['id']; ?>">
                            <div class="row">
                                ...
                                <input type="text" name="section_name" class="form-control" value="<?php echo $data['section_name'];?>">
                                </div>
                                <div class="col-md-6">
                                    <label>page</label>
                                    <input type="text" name="page" class="form-control" value="<?php echo $data['page'];?>">
                                </div>
                            </div>

                            <button type="submit" class="btn btn-success" name="section_edit" value="edit">Update section</button>                            <div class="clearfix"></div>
                        </form>
                    </div>
                </div>
            </div>
